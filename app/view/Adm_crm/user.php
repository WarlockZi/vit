            ...
            <div class="tabs">
                ...
                <section id="content-tab1" class="column">
                    ...
                    <div class='admin-flex-table column'>
                        ...
                        <div class='row'>
                            <strong>email :</strong><span id='email'
                                                          contenteditable="true"><?= $user['email']; ?></span>
                        </div>
                        <div class='row'>
                        ...
                        <div class='row'>
                            <strong>phone:</strong><span id='phone'
                                                         contenteditable="true"><?= $user['phone']; ?> </span>
                        </div>
                        <div class='row'>
                    ...
                    <div class='admin-flex-table column'>
                        <? foreach ($rights as $right): ?>
                            <div class="row">
                                ...
                                <input class="right" data-id='<?= $right['id'] ?>' type="checkbox"
