...
<div class = "testParamsBorder none">
	...
	<div class = "table-right" > 
		<input id = "saveTestName" class = "testParamsField" type = "text" value = "<?=$test['test_name']?>"></input>
	...
	<div class = "buttons">
		<div id = "TestParamsDEL" class="smallButton testParamsField">Удалить</div>
		<div id = "saveTestParamsOK" class="smallButton testParamsField">ОК</div>
