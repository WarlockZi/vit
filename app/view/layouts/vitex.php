...
<html lang="ru">
  <head>
    ...
    <? $this::getMeta() ?>
    <link rel="shortcut icon" href="<? //= PROJ   ?>/public/favicon.ico" type="image/x-icon">
          ...
          <div class = 'h-upper'>
            <div class="logo-wrap">
              <a class="logo" <?= $vars['home'] ?: '' ?> aria-label="На главную">
                <svg width="235" height="45" version="1.1" viewBox="0 0 140.93602 25.903431" >
                <defs>
                ...
                <span class="logo-desc">Cредства <br>индивидуальной защиты <br>оптом<span class="title">  </span></span>
              </a>
            </div>
            <div class = 'icon-phone'>
              ...
              <div class="popup-info">
                <div class="inner">
                  ...
                  <p class="phones">
                    <a href="tel:+78172217762">+7 (8172) 21-77-62</a><br>
                    <a href="tel:+79095942911">+7 (909) 594-29-11</a></p>
                  <p></p>
                </div>
              </div>

              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="25" height="17" viewBox="2 0 13 13">
              <title>down</title>
              <g fill = '#e30000'>
            ...
            <div class="user-menu">
              ...
              <? if (!isset($user)): ?> 
                 <a class = "enter-button" href="<?= PROJ ?>/user/login">
                   <svg id="icon-locked" version="1.1" xmlns="http://www.w3.org/2000/svg" width="23" height="16" viewBox="7 0 8 16">
                   <title>lock-fill</title>
                   <path d="M7 0c-2.754 0-4.998 2.242-4.998 5v1h-2.002v7c0 1.655 1.345 3 3 3h6c1.655 0 3-1.345 3-3v-8c0-2.758-2.244-5-5-5zM5.998 12c-0.551 0-0.998-0.447-0.998-1s0.447-1 0.998-1c0.553 0 1 0.447 1 1s-0.447 1-1 1zM10 6h-5.998v-1c0-1.655 1.346-3 2.998-3 1.655 0 3 1.345 3 3v1z"></path>
                   </svg>
                   Вход</a>
              <? else: ?>
                 ...
                 <div class = "user-button">
                   ...
                   <div class="nav">
                     ...
                     <? if (in_array('3', $rightId)): // Admin?>

                     <? endif; ?>
                     <? if (in_array('1', $rightId)): // редактировать ?>
                        <a href="<?= PROJ ?>/edit/1">Редактировать тесты</a>
                        <a href="<?= PROJ ?>/freetest/edit/41">Редактировать свободный тест</a>
                     <? endif; ?>
                     <? if (in_array('2', $rightId)): // проходить ?>
                        <a href="<?= PROJ ?>/test/1">Проходить тесты</a>
                        <a href="<?= PROJ ?>/freetest/41">Свободный тест</a>
                     <? endif; ?>
                     <? if (in_array('4', $rightId)): // SU ?>
          ...
          <div class = 'h-lower'>
            ...
            <div id="title-search" class="search-block">
              <form action="search" method="GET">
                <input id="autocomplete" type="text" placeholder="Поиск" name="q" value="" size="40" maxlength="50" class="form-text" autocomplete="on" aria-label = "поиск">
                <!--<label for="search-go">-->
                ...
                <!--</label>-->
                <!--<input name="s" type="submit" value="искать" class="form-submit">-->
              </form>
            </div>
