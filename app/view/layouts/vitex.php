...
<head>
	...
	<style>
		...
		#menu, #toggle-button, #toggle-label, .nav {
			display: none;
		}
		...
		<div class="inner-wrap">
			<div class='h-upper'>
				<div class="logo-wrap">
					...
					<img src="/pic/logo-square.svg" class="logo-square" alt="logo-square">
					<img src="/pic/logo-vitex.svg" class="logo-vitex" alt="logo-vitex">
