     ...
     function check(input) {
        ...
        for (i = 0; i < holder.length; i++) {
            ...
            holder[i].ondrop = async function (e) {
                ...
                this.classList.remove('hover');
                debugger;
                await previewfile(e.dataTransfer.files[0], this);
                save(e.dataTransfer.files[0], this);
            };
        }

        fileupload.map(i => i.onchange = async function () {
                debugger;
                await previewfile(this.files[0], this);
                save(this.files[0], this);
